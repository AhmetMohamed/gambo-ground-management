...
export const groundsData: GroundType[] = [
  {
    ...
    description:
      "Professional-grade stadium with full amenities and seating for spectators.",
    imageUrl:
  ...
  },
  {
    ...
    description:
      "Dedicated training pitch ideal for team practice and skill development.",
    imageUrl:
      "https://images.unsplash.com/photo-1518495973542-4542c06a5843?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=60",
    facilities: [
      "Training Equipment",
      "Floodlights",
  ...
  },
  {
    ...
    imageUrl:
      "https://images.unsplash.com/photo-1469474968028-56623f02e42e?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=60",
